...
public class ShareUtils {
	...
	private static void addWXPlatform(Context context) {
		...
		String appId = ShareConstants.WEXIN_APPID;
		String appSecret = ShareConstants.WEXIN_APPSECRET;
		// 添加微信平台
	...
	private static void addQQQZonePlatform(Context context) {
		String appId = ShareConstants.QQZONE_APPID;
		String appKey = ShareConstants.QQZONE_APPKEY;
	...
	public static void setShareContent(Context context, ShareDomain shareDomain) {
		...
		String temp = targetUrl + context.getString(R.string.toolbar_goBack_title);
		...
		QZoneSsoHandler qZoneSsoHandler = new QZoneSsoHandler(
				(Activity) context, ShareConstants.QQZONE_APPID,
				ShareConstants.QQZONE_APPKEY);
		qZoneSsoHandler.addToSocialSDK();
